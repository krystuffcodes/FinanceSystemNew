-- Clean and corrected fn_crm database creation script
USE master;
GO
...
-- Create new database (let SQL Server choose default path for Express)
...
PRINT 'Setup completed! Login with Username: admin, Password: admin';