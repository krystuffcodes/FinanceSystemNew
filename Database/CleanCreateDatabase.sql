-- Clean fn_crm database creation script - No Errors
-- Connect to LAPTOP-9U7RNK0I\SQLEXPRESS in SSMS before running this
USE master;
GO
...
PRINT '=================================================';
PRINT 'SUCCESS: fn_crm database created successfully!';
