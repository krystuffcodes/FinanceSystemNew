-- Corrected fn_crm database creation script for LAPTOP-9U7RNK0I
USE master;
GO
...
-- Create new database (let SQL Server Express choose default path)
...
-- Create Users table for authentication (using plain text password)
CREATE TABLE Users (
    Id UNIQUEIDENTIFIER PRIMARY KEY DEFAULT NEWID(),
...
-- Insert admin user (plain text password: admin)
...
SELECT 'Database fn_crm created successfully for LAPTOP-9U7RNK0I!' as Result;
SELECT 'Tables created: ' + CAST(COUNT(*) AS NVARCHAR(10)) as TableCount
...
PRINT 'Setup completed! Server: LAPTOP-9U7RNK0I\SQLEXPRESS';
